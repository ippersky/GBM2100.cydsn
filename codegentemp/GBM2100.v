...
module CapSense_v3_0_2 ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/4db2e9d3-9f70-4f4e-a919-7eefada41863"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/77fd7f86-2082-41fa-a471-914d5f07502d"),
		  .width(2),
		  .sio_grp_cnt(0),
		  .drive_mode("0,0"),
		  .ibuf_enabled("0,0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/dbc12ae1-a607-4701-99cc-6261716a9147"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/2605f567-73b7-435d-b3b9-174766b96934"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/0113321b-4a37-46f6-8407-2f8646c68756"),
		  .width(5),
		  .sio_grp_cnt(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("91e3ec64-e061-4947-8cc6-62603662a05f/8ed50244-d239-4c9b-9207-b8e71ce193dc"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
...
module SCB_I2C_PDL_v2_0_3 (
	...
	cy_clock_v1_0
		#(.id("0011ca31-6bd7-44b1-b50b-5d285037fbee/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("0011ca31-6bd7-44b1-b50b-5d285037fbee/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("0011ca31-6bd7-44b1-b50b-5d285037fbee/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module SCB_I2C_PDL_v2_0_4 (
	...
	cy_clock_v1_0
		#(.id("6b65d45f-fca8-409a-95be-2d6eb3dd06c5/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("127877237.851662"),
		  .is_direct(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("6b65d45f-fca8-409a-95be-2d6eb3dd06c5/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("6b65d45f-fca8-409a-95be-2d6eb3dd06c5/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module SCB_UART_PDL_v2_0_5 (
	...
	cy_clock_v1_0
		#(.id("55a5741f-60af-4a2b-9f91-41785752579c/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("55a5741f-60af-4a2b-9f91-41785752579c/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("55a5741f-60af-4a2b-9f91-41785752579c/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module top ;
    ...
    SCB_I2C_PDL_v2_0_3 I2C_BMI (
        .clock(1'b0),
        .scl_b(Net_502),
        .scl_trig(Net_504),
        .sda_b(Net_503));

    SCB_I2C_PDL_v2_0_4 I2C_MAX (
        .clock(1'b0),
        .scl_b(Net_506),
        .scl_trig(Net_508),
        .sda_b(Net_507));
